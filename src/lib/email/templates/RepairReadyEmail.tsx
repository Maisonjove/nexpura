...
export interface RepairReadyEmailProps {
  customerName: string
  itemType: string
  repairNumber: string
...
export default function RepairReadyEmail({
  customerName,
  itemType,
  repairNumber,
  itemDescription,
  ...
  businessPhone,
  businessAddress,
}: RepairReadyEmailProps) {
  return (
    <html>
      <head>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Your repair is ready — {businessName}</title>
      </head>
                    ...
                    <tr>
                      <td style={{ backgroundColor: '#FFFFFF', padding: '40px' }}>
                        ...
                        <p style={{ margin: '0 0 32px', fontSize: '14px', color: '#4a5568', lineHeight: '1.6' }}>
                          Your <strong>{itemType}</strong> repair is complete and ready for collection.
                        </p>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style={{ paddingBottom: '14px', width: '50%', verticalAlign: 'top' }}>
                                        <p style={{ margin: 0, fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600' }}>Repair Reference</p>
                                    ...
                                    {workDescription && (
                                      <tr>
                                        <td colSpan={2} style={{ paddingBottom: '14px', verticalAlign: 'top' }}>
                                          <p style={{ margin: 0, fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600' }}>Work Completed</p>
                                    ...
                                    {(businessAddress || businessPhone || businessEmail) && (
                                      <tr>
                                        <td colSpan={2} style={{ borderTop: '1px solid #E8E8E8', paddingTop: '14px', verticalAlign: 'top' }}>
                                          <p style={{ margin: 0, fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600' }}>Contact Us</p>
                        ...
                        <p style={{ margin: '0', fontSize: '14px', color: '#4a5568', lineHeight: '1.6', textAlign: 'center' }}>
                          We look forward to seeing you. Please bring this email or your repair reference when collecting.
                        </p>
                      </td>
                    </tr>
