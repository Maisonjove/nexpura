...
function ListView({ jobs }: { jobs: BespokeJob[] }) {
  if (jobs.length === 0) {
    return (
      <div className="bg-white border border-platinum rounded-xl p-12 text-center">
        <p className="text-forest/40 text-sm">No bespoke jobs found.</p>
        <Link href="/bespoke/new" className="mt-3 inline-block text-sm text-sage hover:underline">
