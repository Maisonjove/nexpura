          ...
          <div className="space-y-3">
            {supplier.email && (
              <div className="flex items-start gap-3">
                ...
                <a href={`mailto:${supplier.email}`} className="text-sm text-[#8B7355] hover:underline">
                  {supplier.email}
                </a>
              </div>
            )}
            {supplier.phone && (
              <div className="flex items-start gap-3">
                ...
                <a href={`tel:${supplier.phone}`} className="text-sm text-stone-900 hover:text-[#8B7355] transition-colors">
                  {supplier.phone}
                </a>
              </div>
            )}
            {supplier.website && (
              <div className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="text-sm text-[#8B7355] hover:underline truncate"
                >
                  {supplier.website}
                </a>
              </div>
