    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-fraunces text-2xl font-semibold text-forest">Edit Expense</h1>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="mb-1">
            <Link href="/expenses" className="text-forest/40 hover:text-forest transition-colors text-sm">
              ← Expenses
            </Link>
          </div>
      ...
      <div className="bg-white border border-platinum rounded-xl p-5 shadow-sm">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-forest/40 uppercase tracking-wider">Amount</span>
            <span className="font-fraunces text-2xl font-semibold text-forest">
              {fmtCurrency(expense.amount)}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-forest/40 uppercase tracking-wider">Category</span>
            <span
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-forest/40 uppercase tracking-wider">Date</span>
          ...
          {expense.invoice_ref && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-forest font-mono">{expense.invoice_ref}</span>
            </div>
          )}
        </div>
        ...
        {expense.notes && (
          <div className="mt-4 pt-4 border-t border-platinum">
            <p className="text-xs font-medium text-forest/40 uppercase tracking-wider mb-2">Notes</p>
            <p className="text-sm text-forest/70 whitespace-pre-wrap">{expense.notes}</p>
          </div>
        )}
      </div>
