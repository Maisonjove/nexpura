      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white border border-stone-200 rounded-xl p-6 shadow-sm space-y-4">
          ...
          <div>
            ...
            <input name="title" required defaultValue={passport.title} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors" />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1.5">Jewellery Type</label>
            <select name="jewellery_type" value={jewelleryType} onChange={(e) => { setJewelleryType(e.target.value); if (e.target.value === "ring") setRingOpen(true); }} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
          ...
          <div>
            ...
            <textarea name="description" rows={3} defaultValue={passport.description ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors resize-none" />
          </div>
        </div>
        ...
        <div className="bg-white border border-stone-200 rounded-xl p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select name="metal_type" defaultValue={passport.metal_type ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
            ...
            <div>
              ...
              <select name="metal_colour" defaultValue={passport.metal_colour ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
                <option value="">Select…</option>
            ...
            <div>
              ...
              <select name="metal_purity" defaultValue={passport.metal_purity ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
                <option value="">Select…</option>
            ...
            <div>
              ...
              <input name="metal_weight_grams" type="number" step="0.01" min="0" defaultValue={passport.metal_weight_grams ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors" />
            </div>
          </div>
        </div>
            ...
            <div className="px-6 pb-6 border-t border-stone-200">
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div>
                  ...
                  <select name="stone_type" defaultValue={passport.stone_type ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
                    <option value="">Select…</option>
                ...
                <div>
                  ...
                  <select name="stone_shape" defaultValue={passport.stone_shape ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors">
                    <option value="">Select…</option>
                    {STONE_SHAPES.map((s) => (<option key={s} value={s}>{s.replace(/_/g, " ").replace(/\b\w/g, (c) => c.toUpperCase())}</option>))}
                  </select>
                </div>
                <div><label className="block text-xs font-medium text-gray-600 mb-1.5">Carat</label><input name="stone_carat" type="number" step="0.01" min="0" defaultValue={passport.stone_carat ?? ""} className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm text-stone-900 focus:outline-none focus:ring-2 focus:ring-[#8B7355]/30 focus:border-[#8B7355] transition-colors" /></div>
        ...
        <div className="bg-white border border-stone-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <button type="button" onClick={() => setIsPublic(!isPublic)} className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isPublic ? "bg-[#8B7355]" : "bg-gray-200"}`}>
        ...
        <div className="flex items-center justify-end gap-3 pb-6">
          ...
          <button type="submit" disabled={loading} className="px-5 py-2.5 bg-[#8B7355] text-white text-sm font-medium rounded-lg hover:bg-[#7A6347] transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
