      ...
      <div className="bg-white border border-stone-200 rounded-2xl p-5 shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-medium bg-white border border-stone-200 text-stone-900 rounded-md hover:bg-stone-50 transition-colors"
          >
          ...
          <Link
            ...
            className="border border-stone-200 text-stone-600 text-xs font-medium px-4 py-2 rounded-md hover:bg-stone-50 transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {customerMobile && (
          <div className="grid grid-cols-2 gap-2">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-stone-50 border border-stone-200 text-stone-700 text-xs font-medium px-4 py-2 rounded-md hover:border-amber-200 hover:bg-amber-50 hover:text-amber-700 transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-stone-50 border border-stone-200 text-stone-700 text-xs font-medium px-4 py-2 rounded-md hover:border-green-200 hover:bg-green-50 hover:text-green-700 transition-all"
            >
        ...
        {!readOnly && customerEmail && (
          <div>
            <button
              ...
              disabled={isSending}
              className="w-full flex items-center justify-center gap-2 bg-white border border-stone-200 text-stone-700 text-sm font-medium px-4 py-2.5 rounded-md hover:border-amber-600 hover:text-amber-700 transition-all disabled:opacity-50"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {!readOnly && nextStage && !isTerminal && (
          <div>
            <button
              ...
              className="w-full bg-nexpura-bronze text-white text-sm font-medium px-4 py-2.5 rounded-md hover:bg-nexpura-bronze-hover transition-colors flex items-center justify-center gap-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
        ...
        {!readOnly && currentStage === "quoted" && quotedPriceRaw && (
          <div>
            <button
              ...
              className="w-full bg-nexpura-bronze text-white text-sm font-medium px-4 py-2.5 rounded-md hover:bg-nexpura-bronze-hover transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {currentStage === "collected" && (
          <div className="flex items-center gap-2 text-sm text-stone-500 bg-stone-50 border border-stone-200 rounded-md px-4 py-3">
            <svg
        ...
        {currentStage === "cancelled" && (
          <div className="flex items-center gap-2 text-sm text-stone-400 bg-stone-50 border border-stone-900/10 rounded-md px-4 py-3">
            <svg
        ...
        <div className="border-t border-stone-200 pt-4 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-stone-400 uppercase tracking-[0.15em]">
              Due Date
            </span>
            {dueDate ? (
              <span
        ...
        {customerId && customerName && (
          <div className="border-t border-stone-200 pt-4">
            <p className="text-xs font-medium text-stone-400 uppercase tracking-[0.15em] mb-1.5">
              Customer
            </p>
            <Link
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={isPending}
                    className="flex-1 bg-red-500 text-white text-xs font-medium py-2 rounded-md hover:bg-red-600 transition-colors disabled:opacity-50"
                  >
                    {isPending ? "Archiving…" : "Confirm Archive"}
                  </button>
                  <button
                    onClick={() => setShowArchiveConfirm(false)}
                    className="flex-1 bg-white border border-stone-200 text-stone-900 text-xs font-medium py-2 rounded-md hover:bg-stone-50 transition-colors"
                  >
                    Cancel
                  </button>
                </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 text-sm bg-white border border-stone-200 rounded-md text-stone-900 placeholder-stone-300 focus:outline-none focus:border-amber-600 focus:ring-1 focus:ring-amber-600 resize-none"
              />
            </div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <button
                onClick={() => setShowModal(false)}
                className="flex-1 bg-white border border-stone-200 text-stone-900 text-sm font-medium py-2.5 rounded-md hover:bg-stone-50 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isPending}
                className="flex-1 nx-btn-primary cursor-pointer disabled:opacity-50"
              >
