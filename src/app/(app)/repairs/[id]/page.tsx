    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Photos placeholder */}
          <div className="bg-white border border-platinum rounded-xl p-6 shadow-sm">
            <h2 className="font-fraunces text-base font-semibold text-forest mb-2">
              Intake Photos
            </h2>
            <div className="border-2 border-dashed border-platinum rounded-lg p-8 text-center">
              <svg
                className="w-10 h-10 text-forest/20 mx-auto mb-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-sm text-forest/30">Photo upload coming soon</p>
            </div>
          </div>
        </div>
