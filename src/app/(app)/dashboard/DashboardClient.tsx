...
// Right sidebar (Tasks / Ready / Overdue / Recent activity) is secondary —
// the jeweller's first attention is header → category grid. Split it off
// so its ~110 lines of JSX + 5 sub-section renders stay out of the main
// DashboardClient bundle. ssr:true so the sidebar still server-renders
// for good first paint; the split is a bundle / parse-time win, not a
// render-order one.
