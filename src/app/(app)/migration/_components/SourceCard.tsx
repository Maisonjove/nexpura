  ...
  return (
    <div className="bg-white border border-stone-200 rounded-xl shadow-sm p-5 flex flex-col gap-3 hover:border-stone-300 transition-colors">
      ...
      <button
        onClick={handleStart}
        disabled={loading}
        className="mt-auto flex items-center justify-center gap-2 bg-amber-700 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-amber-700 transition-colors disabled:opacity-50"
      >
        {loading ? (
