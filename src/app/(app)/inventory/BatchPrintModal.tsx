...
export default function BatchPrintModal({ items, tenantName, onClose }: BatchPrintModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl border border-platinum shadow-xl w-full max-w-2xl p-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h3 className="font-fraunces text-lg font-semibold text-forest">Print Stock Tags</h3>
            <p className="text-sm text-forest/50 mt-0.5">{items.length} item{items.length === 1 ? "" : "s"} selected</p>
          </div>
          ...
          <>
            ...
            {selectedTemplate && (
              <div className="mb-5">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-platinum overflow-auto max-h-64">
