...
const pains = [
  ...
  { title: 'No real stock visibility', body: 'You find out something is sold out at the point of sale.' },
  { title: 'Memo chaos', body: 'Pieces on loan, no trail, no due-back reminders, no audit.' },
  { title: 'Disconnected tools', body: 'POS in one system, repairs in a notebook, quotes in email.' },
  { title: 'Customer communication gaps', body: 'Clients have no idea where their order or repair is.' },
  { title: 'No audit trail', body: 'When something goes wrong, there is nothing to trace back.' },
]
