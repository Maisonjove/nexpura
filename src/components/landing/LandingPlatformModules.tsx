...
const modules = [
  ...
  { n: '02', title: 'Inventory', desc: 'Real-time stock across items, stones, metals, and components.' },
  ...
  { n: '08', title: 'Digital Passports', desc: 'QR-linked authenticity certificates for every piece you sell.' },
  { n: '09', title: 'Memo & Consignment', desc: 'Track loaned pieces, due-back dates, and commission splits.' },
